...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_app_network_service__ = __webpack_require__("./src/app/services/app-network.service.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__services_app_network_service__["a" /* AppNetworkService */],
                {
                    provide: __WEBPACK_IMPORTED_MODULE_1__angular_core__["APP_INITIALIZER"],
                    useFactory: appInitializerFn,
                    multi: true,
                    deps: [__WEBPACK_IMPORTED_MODULE_9__services_app_network_service__["a" /* AppNetworkService */]]
                }
            ],
...
var AppNetworkService = (function () {
    ...
    AppNetworkService.prototype.verifyCookies = function (authCookie, roleauthCookie) {
    ...
    AppNetworkService.prototype.getRequest = function (url) {
        ...
        return this.http
            ...
            if (res.headers.get("roleauth")) {
                ...
                _this.setCookie("roleauth", _this._roleauth);
            }
            return res;
        });
    };
